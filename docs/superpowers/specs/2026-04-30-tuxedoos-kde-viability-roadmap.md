...
| W4b | 2 | CI dependency-list fix | `in-progress` | `w4b-ci-dependency-fix` | `2026-05-02-w4b-ci-dependency-fix-design.md` | `2026-05-02-w4b-ci-dependency-fix.md` | yes | Add `clang`, `libclang-dev`, `libssl-dev`, `libpipewire-0.3-dev` to `.github/workflows/ci.yml`; remove dead `libgtk4-layer-shell-dev`; add `--locked` + `cargo build --release`; fold in 4 CI-hygiene additions (timeout, permissions, concurrency, CARGO_TERM_COLOR). |
